...
print('average sensitivity: {:.2%}'.format((ExU.sensitivity() + ExH.sensitivity() + RegF.sensitivity() + RegK.sensitivity() + NovS.sensitivity() + NovM.sensitivity()) / 6))
print('average specificity: {:.2%}'.format((ExU.specificity() + ExH.specificity() + RegF.specificity() + RegK.specificity() + NovS.specificity() + NovM.specificity()) / 6))
print('average f1 value: {:.2%}'.format((ExU.f1_value() + ExH.f1_value() + RegF.f1_value() + RegK.f1_value() + NovS.f1_value() + NovM.f1_value()) / 6))
